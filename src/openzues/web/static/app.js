...
notificationRouteFormEl.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    const defaultEvents = ["slack", "telegram", "discord", "whatsapp", "zalo", "googlechat", "nextcloud-talk", "synology-chat", "mattermost", "msteams", "signal", "irc", "twitch", "line", "matrix"].includes(routeKind)
