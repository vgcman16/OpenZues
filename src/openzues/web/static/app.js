...
notificationRouteFormEl.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    const defaultEvents = ["slack", "telegram", "discord", "whatsapp", "zalo", "feishu", "googlechat", "nextcloud-talk", "synology-chat", "mattermost", "msteams", "signal", "irc", "twitch", "tlon", "line", "matrix"].includes(routeKind)
