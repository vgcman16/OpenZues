...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~95.0% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK runtime-group-policy helper slice is checkpointed in
`b11adc13`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Runtime group-policy SDK helper shim checkpointed in `b11adc13` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader SDK helper/runtime breadth |
