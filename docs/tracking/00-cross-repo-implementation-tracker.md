...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~82.6% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin secret-ref-runtime slice is checkpointed in `8b9f3671`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Secret-ref-runtime shim checkpointed in `8b9f3671` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
