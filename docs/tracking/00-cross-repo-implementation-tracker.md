...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~99.9% | Active, broad parity still open; evidence band ~80-99.9999999999999999999999999999999999999999999999999% | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
| Runtime/CLI/doctor native bridge | ~99.92% | Mostly landed; packaging, QR remote secret diagnostics, and installed plugin depth remain | `docs/openclaw-parity-progress.md` |
...
| OZ-COMP-001 | Companion apps/nodes parity | QR approval guidance checkpointed in `d6052fda`; QR JSON setup-code contract checkpointed in `b79b87c3`; device pairing public-key persistence/projection checkpointed in `bef0652f`; QR public-cleartext URL rejection checkpointed in `24d89215`; QR remote saved URL/auth config checkpointed in `3d63d136`; QR Tailscale MagicDNS checkpointed in `beb67302` | Repo-wide +0.1%, companion/setup breadth +0.1% | Continue QR remote secret diagnostics or next startup/update edge |
...
checkpointed in `beb67302`. Continue QR remote secret diagnostics,
provider/runtime breadth, or the next package startup/update edge.
