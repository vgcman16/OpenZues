...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~71.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin reply-chunking helper shim slice is checkpointed in
`b000f51c`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Reply-chunking helper shim checkpointed in `b000f51c` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
