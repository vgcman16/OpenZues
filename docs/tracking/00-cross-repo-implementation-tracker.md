...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~95.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK browser-config facade slice is checkpointed in
`300224b7`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Browser config facade shim checkpointed in `300224b7` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader SDK helper/runtime breadth |
