...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~95.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK browser-trash helper slice is checkpointed in
`9a90555e`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Browser trash SDK helper shim checkpointed in `9a90555e` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader SDK helper/runtime breadth |
