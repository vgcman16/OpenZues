...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~74.1% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin command-detection shim slice is checkpointed in `c0c5e8fa`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Command-detection shim checkpointed in `c0c5e8fa` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
