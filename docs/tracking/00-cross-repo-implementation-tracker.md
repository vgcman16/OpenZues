...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~86.6% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin config-paths slice is checkpointed in `c1a26ebe`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Config-paths checkpointed in `c1a26ebe` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
