...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~83.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin host-runtime slice is checkpointed in `355ebc11`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Host-runtime shim checkpointed in `355ebc11` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
