...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~94.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK agent-runtime provider-auth alias helper slice is
checkpointed in `61731b33`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent runtime provider-auth alias SDK shim checkpointed in `61731b33` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue TTS exports and agent-command breadth |
