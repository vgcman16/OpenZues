...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~72.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin dangerous-name shim slice is checkpointed in `01473fb4`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Dangerous-name shim checkpointed in `01473fb4` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
