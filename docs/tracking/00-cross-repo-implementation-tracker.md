...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~98.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK zalouser facade slice is checkpointed in `6f0c70b5`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Zalouser facade SDK shim checkpointed in `6f0c70b5` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue adjacent SDK helper/runtime breadth |
