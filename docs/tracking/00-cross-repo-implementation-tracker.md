...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~74.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin global-singleton shim slice is checkpointed in `d773e608`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Global-singleton shim checkpointed in `d773e608` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
