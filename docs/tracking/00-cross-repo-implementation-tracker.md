...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~73.0% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin async-lock-runtime shim slice is checkpointed in `9cc677fe`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Async-lock-runtime shim checkpointed in `9cc677fe` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
