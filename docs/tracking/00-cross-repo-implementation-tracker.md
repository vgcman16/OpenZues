...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~73.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin text-autolink-runtime shim slice is checkpointed in `bcce41be`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Text-autolink-runtime shim checkpointed in `bcce41be` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
