...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~99.9% | Active, broad parity still open; evidence band ~80-99.9998% | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK provider-http-test-mocks facade slice is checkpointed in `462e8f82`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Provider HTTP test mocks SDK shim checkpointed in `462e8f82` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue exact `testing` compatibility barrel |
