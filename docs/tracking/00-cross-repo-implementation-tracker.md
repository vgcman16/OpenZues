...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~94.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK google-model-id alias slice is checkpointed in
`67db67b5`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Google model-id alias SDK shim checkpointed in `67db67b5` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader SDK helper/runtime breadth |
