...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~86.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin poll-runtime slice is checkpointed in `83f15bfa`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Poll-runtime checkpointed in `83f15bfa` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
