...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~82.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin secret-input-schema slice is checkpointed in `7935af8b`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Secret-input-schema shim checkpointed in `7935af8b` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
