...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~87.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin runtime-fetch slice is checkpointed in `14cdafc6`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Runtime-fetch checkpointed in `14cdafc6` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
