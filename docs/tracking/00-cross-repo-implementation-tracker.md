...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~98.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK plugin-entry facade slice is checkpointed in
`b1fd730f`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Plugin entry facade SDK shim checkpointed in `b1fd730f` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue adjacent SDK helper/runtime breadth |
