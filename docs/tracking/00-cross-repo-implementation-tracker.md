...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~75.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin direct-DM access shim slice is checkpointed in `5258f537`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Direct-DM access shim checkpointed in `5258f537` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
