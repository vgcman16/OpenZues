...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~88.0% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin type-only SDK barrel slice is checkpointed in `fceeecc8`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Type-only SDK barrels checkpointed in `fceeecc8` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
