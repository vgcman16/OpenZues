...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~94.0% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK agent-runtime model-auth helper slice is
checkpointed in `b93c187b`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent runtime model-auth SDK shim checkpointed in `b93c187b` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue provider-auth alias-map depth, schema/typebox, web-tool helpers, TTS exports, and agent-command breadth |
