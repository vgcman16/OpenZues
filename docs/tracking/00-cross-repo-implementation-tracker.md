...
The installed-record manifest runtime activation slice is checkpointed in
`b8f39fe3`. Any follow-up changes should target the next queue head only:
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Installed-record manifest runtime activation checkpointed in `b8f39fe3` | Repo-wide +0.1%, CLI/runtime +0.1% | Continue real installed module import/activation depth |
