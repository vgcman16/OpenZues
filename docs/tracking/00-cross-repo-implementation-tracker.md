...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~98.0% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK provider-usage helper slice is checkpointed
in `cbc85bd2`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Provider-usage SDK helper shim checkpointed in `cbc85bd2` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue adjacent provider/runtime SDK helper breadth |
