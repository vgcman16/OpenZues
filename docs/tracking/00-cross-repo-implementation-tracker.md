...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~74.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin markdown-table-runtime shim slice is checkpointed in `6e51b8a9`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Markdown-table-runtime shim checkpointed in `6e51b8a9` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
