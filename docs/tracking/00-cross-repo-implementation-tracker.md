...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~80.0% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin channel inbound roots slice is checkpointed in `1e1d6c23`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Channel inbound roots shim checkpointed in `1e1d6c23` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
