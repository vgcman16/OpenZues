...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~94.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK agent-runtime command entrypoint slice is checkpointed
in `9e6496fb`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent runtime command entrypoint SDK shim checkpointed in `9e6496fb` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader SDK helper/runtime breadth |
