...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~91.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported package memory-host-sdk facade slice is checkpointed in
`c95e0129`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Memory host SDK package facades checkpointed in `c95e0129` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader unresolved helper/runtime queue; next `speech-core` |
