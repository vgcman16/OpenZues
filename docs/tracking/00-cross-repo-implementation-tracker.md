...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~79.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin ACP binding resolve slice is checkpointed in `4c9ed6d6`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | ACP binding resolve shim checkpointed in `4c9ed6d6` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
