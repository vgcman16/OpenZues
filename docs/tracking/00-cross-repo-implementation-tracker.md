...
The plugin inspect human runtime surface sections slice is checkpointed in
`f2221877`. Any follow-up changes should target the next queue head only:
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Plugin inspect human runtime surface sections checkpointed in `f2221877` | Repo-wide +0.1%, CLI/runtime +0.1% | Continue real installed module import/activation depth |
