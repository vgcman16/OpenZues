...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~68.6% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The Feishu/Lark edit message action slice is checkpointed in `2203efa7`.
...
| OZ-PROV-001 | Provider-native outbound/inbound breadth | Feishu/Lark edit message action checkpointed in `2203efa7` | Repo-wide +0.1%, provider-native breadth +0.1% | Continue Feishu/Lark `pin` message action |
