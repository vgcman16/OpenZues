...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~97.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK provider-tools helper slice is checkpointed in
`2762ee46`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Provider-tools SDK helper shim checkpointed in `2762ee46` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue provider stream/transport SDK helper breadth |
