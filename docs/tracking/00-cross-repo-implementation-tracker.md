...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~85.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin approval-handler-adapter-runtime slice is checkpointed in
`21aa746b`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Approval-handler-adapter-runtime shim checkpointed in `21aa746b` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue remaining plugin SDK/runtime helper breadth |
