...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~76.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin allowlist-config-edit shim slice is checkpointed in `37677120`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Allowlist-config-edit shim checkpointed in `37677120` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
