...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~97.1% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK plugin-config-runtime helper slice is checkpointed in
`458d6c7f`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Plugin-config-runtime SDK helper shim checkpointed in `458d6c7f` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue adjacent config mutation/runtime SDK helper breadth |
