...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~94.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK agent-runtime TTS helper slice is checkpointed in
`9b328bbd`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent runtime TTS SDK shim checkpointed in `9b328bbd` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue agent-command breadth |
