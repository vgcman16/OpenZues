...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~82.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin inbound-envelope slice is checkpointed in `d5ba314d`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Inbound-envelope shim checkpointed in `d5ba314d` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
