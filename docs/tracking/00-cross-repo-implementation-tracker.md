...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~99.9% | Active, broad parity still open; evidence band ~80-99.9995% | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK test-env facade slice is checkpointed in `e2368bf5`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Test-env SDK shim checkpointed in `e2368bf5` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue exact `test-fixtures` alias |
