...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~74.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin reply-dedupe shim slice is checkpointed in `e3ec8d6c`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Reply-dedupe shim checkpointed in `e3ec8d6c` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
