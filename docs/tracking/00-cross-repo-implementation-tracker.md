...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~76.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin windows-spawn shim slice is checkpointed in `1c172bde`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Windows-spawn shim checkpointed in `1c172bde` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
