...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~93.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK agent-runtime model-catalog lookup slice is
checkpointed in `a5794303`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent runtime model-catalog SDK shim checkpointed in `a5794303` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue live/provider `agent-runtime` facade and agent-command breadth |
