...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~93.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK skills-runtime slice is checkpointed in `106ddcb8`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Skills runtime SDK shim checkpointed in `106ddcb8` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader unresolved helper/runtime queue; next `agent-runtime` |
