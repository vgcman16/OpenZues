...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~96.1% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK browser-node-runtime helper slice is checkpointed in
`bc7ef301`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Browser node-runtime SDK helper shim checkpointed in `bc7ef301` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader SDK helper/runtime breadth |
