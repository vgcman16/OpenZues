...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~93.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK agent-runtime model-selection slice is checkpointed in
`0d009e7d`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent runtime model-selection SDK shim checkpointed in `0d009e7d` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader `agent-runtime` agent-command/tool bridge breadth |
