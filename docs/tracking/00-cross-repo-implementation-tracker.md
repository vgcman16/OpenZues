...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~87.1% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin system-event-runtime slice is checkpointed in `5c49a1be`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | System-event-runtime checkpointed in `5c49a1be` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
