...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~97.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK provider-stream helper slice is checkpointed in
`da9a3e66`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Provider-stream SDK helper shim checkpointed in `da9a3e66` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue provider transport SDK helper breadth |
