...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~71.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin tool-payload shim slice is checkpointed in `387717ed`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Tool-payload shim checkpointed in `387717ed` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
