...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~81.9% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin channel-mention-gating slice is checkpointed in `22e17bc5`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Channel-mention-gating shim checkpointed in `22e17bc5` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
