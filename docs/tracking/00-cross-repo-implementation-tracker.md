...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~63.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The Microsoft Teams threaded reply slice is checkpointed in `927d5787`.
...
| OZ-PROV-001 | Provider-native outbound/inbound breadth | Microsoft Teams threaded reply checkpointed in `927d5787` | Repo-wide +0.1%, provider-native breadth +0.1% | Continue Teams media/vote breadth or next provider-specific send/poll/replay gap |
