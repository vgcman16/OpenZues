...
The installed plugin allowlist activation guard slice is checkpointed in
`73089117`. Any follow-up changes should target the next queue head only:
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Installed plugin allowlist activation guard checkpointed in `73089117` | Repo-wide +0.1%, CLI/runtime +0.1% | Continue real installed module import/activation depth |
