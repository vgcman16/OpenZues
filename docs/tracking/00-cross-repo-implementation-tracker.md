...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~79.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin Anthropic CLI facade slice is checkpointed in `8289eaff`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Anthropic CLI facade shim checkpointed in `8289eaff` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
