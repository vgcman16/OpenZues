...
The imported plugin SDK infra-runtime compatibility facade slice is
checkpointed in `0ba78971`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Infra runtime compatibility SDK shim checkpointed in `0ba78971` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue exact `media-runtime` alias |
