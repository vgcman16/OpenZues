...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~63.9% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The Microsoft Teams file info card media slice is checkpointed in `eb663838`.
...
| OZ-PROV-001 | Provider-native outbound/inbound breadth | Microsoft Teams file info card media checkpointed in `eb663838` | Repo-wide +0.1%, provider-native breadth +0.1% | Continue Teams Graph/FileConsent upload, vote invoke storage, or inbound monitor/session routing |
