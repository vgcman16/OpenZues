...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~80.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin state paths slice is checkpointed in `8c3128bf`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | State paths shim checkpointed in `8c3128bf` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
