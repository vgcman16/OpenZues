...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~88.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin ACPX slice is checkpointed in `c7541c95`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | ACPX checkpointed in `c7541c95` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
