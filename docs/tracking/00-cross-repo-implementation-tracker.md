...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~85.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin approval-gateway-runtime resolver slice is checkpointed in
`29c62d3f`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Approval-gateway-runtime resolver checkpointed in `29c62d3f` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue native approval runtime/handler lifecycle breadth |
