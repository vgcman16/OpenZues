...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~79.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin XAI model-id slice is checkpointed in `6743ca28`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | XAI model-id shim checkpointed in `6743ca28` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
