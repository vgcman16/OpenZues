...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~79.6% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin Anthropic Vertex auth-presence slice is checkpointed in `f7c9e174`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Anthropic Vertex auth-presence shim checkpointed in `f7c9e174` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
