...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~92.9% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK qa-runner-runtime slice is checkpointed in `f9d46a8f`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | QA runner runtime SDK shim checkpointed in `f9d46a8f` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader unresolved helper/runtime queue; next `models-provider-runtime` |
