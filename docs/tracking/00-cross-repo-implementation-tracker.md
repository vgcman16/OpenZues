...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~72.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin string-normalization shim slice is checkpointed in `06cd452d`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | String-normalization shim checkpointed in `06cd452d` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
