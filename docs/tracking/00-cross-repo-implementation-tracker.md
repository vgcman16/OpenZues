...
The manifest migration provider contract slice is verified and awaiting
checkpoint commit.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Migration provider contract metadata verified; checkpoint pending | Repo-wide +0.1%, CLI/runtime +0.1% | Continue plugin manifest/runtime contract breadth |
