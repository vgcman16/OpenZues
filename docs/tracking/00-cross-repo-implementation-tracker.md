...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~88.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin entrypoints slice is checkpointed in `bd810f14`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Entrypoints checkpointed in `bd810f14` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
