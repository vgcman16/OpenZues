...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~88.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin ACP binding runtime slice is checkpointed in `37b428c1`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | ACP binding runtime checkpointed in `37b428c1` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
