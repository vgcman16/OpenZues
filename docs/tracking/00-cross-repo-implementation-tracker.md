...
The plugin inspect human tools section slice is checkpointed in `5ac316c1`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Plugin inspect human tools section checkpointed in `5ac316c1` | Repo-wide +0.1%, CLI/runtime +0.1% | Continue real installed module import/activation depth |
