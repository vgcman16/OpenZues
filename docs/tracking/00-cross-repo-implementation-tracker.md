...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~73.6% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin retry-runtime shim slice is checkpointed in `4608fbc7`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Retry-runtime shim checkpointed in `4608fbc7` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
