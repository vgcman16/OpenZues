...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~99.9% | Active, broad parity still open; evidence band ~80-99.9994% | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK provider-test-contracts facade slice is checkpointed in
`7494160a`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Provider test contracts SDK shim checkpointed in `7494160a` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue exact `test-env` alias |
