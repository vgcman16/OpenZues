...
The Discord thread result fallback slice is verified locally and awaiting its
checkpoint hash.
...
| OZ-PROV-001 | Provider-native outbound/inbound breadth | Discord thread result fallback verified; checkpoint pending | Repo-wide +0.1%, active gateway/method +0.1% | Continue provider-specific send/poll/replay metadata gaps |
