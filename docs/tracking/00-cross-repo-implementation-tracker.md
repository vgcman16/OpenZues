...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~86.9% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin json-store slice is checkpointed in `9ba7a00e`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Json-store checkpointed in `9ba7a00e` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
