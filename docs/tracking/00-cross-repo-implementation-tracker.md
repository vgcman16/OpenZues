...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~87.6% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin media-store slice is checkpointed in `b45381ad`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Media-store checkpointed in `b45381ad` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
