...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~80.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin channel plugin common/core slice is checkpointed in
`b669ff0b`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Channel plugin common/core shim checkpointed in `b669ff0b` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
