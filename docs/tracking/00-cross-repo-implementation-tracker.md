...
The manifest toolMetadata availability gate slice is checkpointed in
`78d905c6`. Any follow-up changes should target the next queue head only:
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Manifest toolMetadata availability gate checkpointed in `78d905c6` | Repo-wide +0.1%, CLI/runtime +0.1% | Continue real installed module import/activation depth |
