...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~68.1% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The Microsoft Teams adaptive-card send action slice is checkpointed in `30fbcc69`.
...
| OZ-PROV-001 | Provider-native outbound/inbound breadth | Microsoft Teams adaptive-card send action checkpointed in `30fbcc69` | Repo-wide +0.1%, provider-native breadth +0.1% | Continue Twitch `message.action send` |
