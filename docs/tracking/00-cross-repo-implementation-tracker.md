...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~99.9% | Active, broad parity still open; evidence band ~80-99.9999% | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK testing compatibility slice is checkpointed in `e6747208`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Testing compatibility SDK shim checkpointed in `e6747208` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue exact `setup` facade |
