...
The plugin inspect human compatibility warnings section slice is checkpointed
in `38b85a1a`. Any follow-up changes should target the next queue head only:
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Plugin inspect human compatibility warnings section checkpointed in `38b85a1a` | Repo-wide +0.1%, CLI/runtime +0.1% | Continue real installed module import/activation depth |
