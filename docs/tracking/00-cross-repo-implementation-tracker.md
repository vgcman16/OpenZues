...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~91.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK image-generation-core slice is checkpointed in
`1a128fa5`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Image-generation-core SDK shim checkpointed in `1a128fa5` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader unresolved helper/runtime queue; next `music-generation-core` |
