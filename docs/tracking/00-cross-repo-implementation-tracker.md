...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~73.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin dedupe-runtime shim slice is checkpointed in `865c9df0`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Dedupe-runtime shim checkpointed in `865c9df0` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
