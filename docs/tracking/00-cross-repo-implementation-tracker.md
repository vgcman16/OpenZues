...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~75.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin allow-from shim slice is checkpointed in `bc6e1344`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Allow-from shim checkpointed in `bc6e1344` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
