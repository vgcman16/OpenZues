...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~74.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin reply-reference shim slice is checkpointed in `3bdeeac0`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Reply-reference shim checkpointed in `3bdeeac0` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
