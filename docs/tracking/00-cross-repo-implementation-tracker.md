...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~81.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin channel-contract-testing slice is checkpointed in `2fdb744c`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Channel-contract-testing shim checkpointed in `2fdb744c` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
