...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~72.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin text-chunking shim slice is checkpointed in `20267310`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Text-chunking shim checkpointed in `20267310` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
