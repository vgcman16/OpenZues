...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~94.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK googlechat-runtime-shared schema slice is checkpointed
in `f721b7e3`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Google Chat runtime shared schema shim checkpointed in `f721b7e3` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader SDK helper/runtime breadth |
