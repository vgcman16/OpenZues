...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~88.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin ACP runtime backend slice is checkpointed in `4833176b`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | ACP runtime backend checkpointed in `4833176b` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
