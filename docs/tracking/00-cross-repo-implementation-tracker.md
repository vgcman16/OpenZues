...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~79.1% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin account-id/configured-id subpath slice is checkpointed in `2e012bc2`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Account-id/configured-id subpath shim checkpointed in `2e012bc2` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
