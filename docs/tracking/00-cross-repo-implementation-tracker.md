...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~75.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin channel-policy shim slice is checkpointed in `9f7b7abd`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Channel-policy shim checkpointed in `9f7b7abd` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
