...
| Runtime/CLI/doctor native bridge | ~99.96% | Mostly landed; packaging, QR gateway-backed remote secret resolution, and installed plugin depth remain | `docs/openclaw-parity-progress.md` |
...
resolution is source/test checkpointed in `6e1b84c4`. Continue gateway-backed
QR remote secret resolution, provider/runtime breadth, or the next
package startup/update edge.
