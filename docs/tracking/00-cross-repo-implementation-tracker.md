...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~86.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin approval-auth-helpers slice is checkpointed in `8511485f`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Approval-auth-helpers checkpointed in `8511485f` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
