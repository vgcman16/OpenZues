...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~86.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin context-visibility-runtime slice is checkpointed in
`1e503fde`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Context-visibility-runtime checkpointed in `1e503fde` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
