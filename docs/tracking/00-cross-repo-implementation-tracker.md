...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~99.6% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK reply-runtime facade slice is checkpointed in
`32213a5c`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Reply runtime SDK shim checkpointed in `32213a5c` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue exact `reply-dispatch-runtime` alias |
