...
The installed plugin runtime activation adapter slice is verified with
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Installed plugin runtime activation adapter verified; checkpoint pending | Repo-wide +0.1%, CLI/runtime +0.1% | Continue real installed module import/activation depth |
