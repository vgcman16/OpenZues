...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~69.9% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The Feishu/Lark audioAsVoice transcode slice is checkpointed in `81c93c0e`.
...
| OZ-PROV-001 | Provider-native outbound/inbound breadth | Feishu/Lark audioAsVoice transcode posture checkpointed in `81c93c0e` | Repo-wide +0.1%, provider-native breadth +0.1% | Continue Feishu/Lark mediaMaxMb media-size limits |
