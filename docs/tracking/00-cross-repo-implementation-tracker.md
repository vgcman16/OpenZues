...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~99.9% | Active, broad parity still open; evidence band ~80-99.9993% | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK plugin-test-runtime facade slice is checkpointed in
`084da020`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Plugin test runtime SDK shim checkpointed in `084da020` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue exact `provider-test-contracts` alias |
