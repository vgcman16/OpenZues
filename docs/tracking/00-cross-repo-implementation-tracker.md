...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~68.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The Feishu/Lark pin message action slice is checkpointed in `1615bdf6`.
...
| OZ-PROV-001 | Provider-native outbound/inbound breadth | Feishu/Lark pin message action checkpointed in `1615bdf6` | Repo-wide +0.1%, provider-native breadth +0.1% | Continue Feishu/Lark `unpin` message action |
