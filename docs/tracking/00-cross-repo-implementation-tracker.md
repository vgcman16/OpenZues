...
The manifest load-path activation-state slice is checkpointed in `54bf33aa`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Manifest load-path activation state checkpointed in `54bf33aa` | Repo-wide +0.1%, CLI/runtime +0.1% | Continue real installed module import/activation depth |
