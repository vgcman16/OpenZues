...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~94.1% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK agent-runtime schema/typebox helper slice is
checkpointed in `0884d4f3`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent runtime schema/typebox SDK shim checkpointed in `0884d4f3` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue provider-auth alias-map depth, web-tool helpers, TTS exports, and agent-command breadth |
