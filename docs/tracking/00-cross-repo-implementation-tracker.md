...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~99.9% | Active, broad parity still open; evidence band ~80-99.99999999999999999999999999999999999999999999999997% | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
| Runtime/CLI/doctor native bridge | ~99.94% | Mostly landed; packaging, QR non-env/gateway-backed remote secret resolution, and installed plugin depth remain | `docs/openclaw-parity-progress.md` |
...
auth preflight is source/test checkpointed in `4057991c`. Continue
non-env/gateway-backed QR remote secret resolution, provider/runtime breadth,
