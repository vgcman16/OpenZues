...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~97.0% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK config-runtime helper slice is checkpointed in
`74fd1711`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Config-runtime SDK helper shim checkpointed in `74fd1711` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue adjacent config/plugin runtime SDK helper breadth |
