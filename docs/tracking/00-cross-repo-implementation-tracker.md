...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~98.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK web-content-extractor facade slice is checkpointed in
`563d69d7`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Web content extractor facade SDK shim checkpointed in `563d69d7` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue adjacent SDK helper/runtime breadth |
