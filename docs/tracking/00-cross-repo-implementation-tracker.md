...
The configured-channel bundled-owner allowlist bypass slice is verified with
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Configured-channel bundled-owner allowlist bypass verified; checkpoint pending | Repo-wide +0.1%, CLI/runtime +0.1% | Continue real installed module import/activation depth |
