...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~97.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK config-mutation helper slice is checkpointed in
`a9813667`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Config-mutation SDK helper shim checkpointed in `a9813667` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue adjacent runtime/provider SDK helper breadth |
