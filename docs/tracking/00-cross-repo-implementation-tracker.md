...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~98.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK speech facade slice is checkpointed in `97ec0d27`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Speech facade SDK shim checkpointed in `97ec0d27` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue adjacent SDK helper/runtime breadth |
