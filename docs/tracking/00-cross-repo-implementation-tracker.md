...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~73.9% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin command-primitives-runtime shim slice is checkpointed in `a39876b1`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Command-primitives-runtime shim checkpointed in `a39876b1` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
