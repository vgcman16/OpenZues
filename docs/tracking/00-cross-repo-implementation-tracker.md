...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~91.9% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK media-generation-runtime slice is checkpointed in
`f475d85a`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Media-generation-runtime SDK shim checkpointed in `f475d85a` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader unresolved helper/runtime queue; next `image-generation-runtime` |
