...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~94.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK agent-runtime web-tool helper slice is checkpointed in
`9bc67f5e`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent runtime web-tool SDK shim checkpointed in `9bc67f5e` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue provider-auth alias-map depth, TTS exports, and agent-command breadth |
