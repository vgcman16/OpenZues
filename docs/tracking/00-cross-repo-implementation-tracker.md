...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~95.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK browser-config-support helper slice is checkpointed in
`33463b7c`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Browser config support SDK helper shim checkpointed in `33463b7c` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader SDK helper/runtime breadth |
