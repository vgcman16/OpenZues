...
| Provider-native inbound/outbound breadth | ~99.99995% | Near-complete bounded provider path; broader provider inventory still open | `docs/openclaw-parity-progress.md` |
| Runtime/CLI/doctor native bridge | ~99.99997% | Mostly landed; packaging and installed plugin depth remain | `docs/openclaw-parity-progress.md` |
| CLI/operator control plane | ~99.99997% | Near-complete bounded native path | `docs/openclaw-parity-progress.md` |
