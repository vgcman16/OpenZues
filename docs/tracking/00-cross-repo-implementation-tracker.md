...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~66.9% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The Microsoft Teams delegated OAuth completion slice is checkpointed in
`3695ca29`.
...
| OZ-PROV-001 | Provider-native outbound/inbound breadth | Microsoft Teams delegated OAuth completion checkpointed in `3695ca29` | Repo-wide +0.1%, provider-native breadth +0.1% | Continue delegated OAuth local callback/manual ergonomics or next provider route/action gap |
