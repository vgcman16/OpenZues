...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~93.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK agent-runtime core slice is checkpointed in `a8e871a3`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent runtime core SDK shim checkpointed in `a8e871a3` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader `agent-runtime` model-selection/agent-command breadth |
