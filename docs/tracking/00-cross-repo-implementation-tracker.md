...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~87.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin group-activation slice is checkpointed in `48d912d7`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Group-activation checkpointed in `48d912d7` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
