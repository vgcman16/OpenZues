...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~79.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin agent-config-primitives slice is checkpointed in `99bb3098`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent-config-primitives shim checkpointed in `99bb3098` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
