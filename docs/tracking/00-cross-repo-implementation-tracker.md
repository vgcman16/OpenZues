...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~81.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin channel-envelope slice is checkpointed in `782e2591`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Channel-envelope shim checkpointed in `782e2591` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
