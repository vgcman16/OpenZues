...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~93.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK agent-runtime PI embedded utility slice is
checkpointed in `db2affa5`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent runtime PI utility SDK shim checkpointed in `db2affa5` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue embedded block chunking, live/provider `agent-runtime` facade, and agent-command breadth |
