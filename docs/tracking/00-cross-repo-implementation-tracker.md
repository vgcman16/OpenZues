...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~68.0% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The Microsoft Teams upload-file message action slice is checkpointed in `86be3a2c`.
...
| OZ-PROV-001 | Provider-native outbound/inbound breadth | Microsoft Teams upload-file message action checkpointed in `86be3a2c` | Repo-wide +0.1%, provider-native breadth +0.1% | Continue Teams adaptive-card `send` action with `card` payload |
