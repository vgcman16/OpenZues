...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~99.9% | Active, broad parity still open; evidence band ~80-99.9997% | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK test-node-mocks facade slice is checkpointed in `b5b60a9e`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Test-node-mocks SDK shim checkpointed in `b5b60a9e` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue exact `provider-http-test-mocks` alias |
