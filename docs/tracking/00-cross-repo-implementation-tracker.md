...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~75.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin channel-inbound shim slice is checkpointed in `aa9825e0`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Channel-inbound shim checkpointed in `aa9825e0` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
