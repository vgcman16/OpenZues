...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~92.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK persistent-dedupe slice is checkpointed in `cfe26bca`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Persistent-dedupe SDK shim checkpointed in `cfe26bca` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader unresolved helper/runtime queue; next `qa-runner-runtime` |
