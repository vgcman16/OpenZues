...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~72.9% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin collection-runtime shim slice is checkpointed in `624e55e4`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Collection-runtime shim checkpointed in `624e55e4` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
