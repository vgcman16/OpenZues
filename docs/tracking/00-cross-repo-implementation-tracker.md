...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~74.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin channel-inbound-debounce shim slice is checkpointed in `9ac09500`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Channel-inbound-debounce shim checkpointed in `9ac09500` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
