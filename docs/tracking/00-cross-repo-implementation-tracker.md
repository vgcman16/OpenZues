...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~83.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin run-command normalized helper slice is checkpointed in
`96c11a19`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Run-command helper shim checkpointed in `96c11a19` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue remaining process/runtime helper breadth |
