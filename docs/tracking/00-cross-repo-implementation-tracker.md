...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~81.4% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin channel-core slice is checkpointed in `20c12150`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Channel-core shim checkpointed in `20c12150` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
