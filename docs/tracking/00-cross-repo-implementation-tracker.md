...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~78.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin directory-runtime shim slice is checkpointed in `a354299e`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Directory-runtime shim checkpointed in `a354299e` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
