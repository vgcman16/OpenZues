...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~92.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK realtime-transcription slice is checkpointed in
`18a7e15b`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Realtime-transcription SDK shim checkpointed in `18a7e15b` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader unresolved helper/runtime queue; next `realtime-voice` |
