...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~93.0% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK models-provider-runtime slice is checkpointed in
`695de78b`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Models provider runtime SDK shim checkpointed in `695de78b` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader unresolved helper/runtime queue; next `skill-commands-runtime` |
