...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~81.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin channel-lifecycle slice is checkpointed in `d3bc5720`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Channel-lifecycle shim checkpointed in `d3bc5720` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
