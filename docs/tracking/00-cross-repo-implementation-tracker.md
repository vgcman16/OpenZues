...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Agent harness runtime SDK helper shim checkpointed in `ee7f5c49` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader SDK helper/runtime breadth |
