...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~73.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin lazy-value shim slice is checkpointed in `ef545716`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Lazy-value shim checkpointed in `ef545716` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
