...
The installed plugin slot activation reason slice is checkpointed in
`209dced0`. Any follow-up changes should target the next queue head only:
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Installed plugin slot activation reason checkpointed in `209dced0` | Repo-wide +0.1%, CLI/runtime +0.1% | Continue real installed module import/activation depth |
