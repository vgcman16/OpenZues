...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~79.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin Anthropic Vertex facade slice is checkpointed in `0ea37843`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Anthropic Vertex facade shim checkpointed in `0ea37843` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
