...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~69.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The Feishu/Lark mediaLocalRoots local-path guard slice is checkpointed in `78cfda1f`.
...
| OZ-PROV-001 | Provider-native outbound/inbound breadth | Feishu/Lark mediaLocalRoots local-path guard checkpointed in `78cfda1f` | Repo-wide +0.1%, provider-native breadth +0.1% | Continue Feishu/Lark audioAsVoice transcode posture |
