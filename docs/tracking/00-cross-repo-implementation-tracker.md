...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~82.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin secret-input-runtime slice is checkpointed in `a3b36775`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Secret-input-runtime shim checkpointed in `a3b36775` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
