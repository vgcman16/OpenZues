...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~99.9% | Active, broad parity still open; evidence band ~80-99.9992% | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK plugin-test-contracts facade slice is checkpointed in
`086382f8`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Plugin test contracts SDK shim checkpointed in `086382f8` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue exact `plugin-test-runtime` alias |
