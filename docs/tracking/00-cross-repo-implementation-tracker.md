...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~67.6% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The Microsoft Teams channel-list action slice is checkpointed in `cf1b7f18`.
...
| OZ-PROV-001 | Provider-native outbound/inbound breadth | Microsoft Teams channel-list action checkpointed in `cf1b7f18` | Repo-wide +0.1%, provider-native breadth +0.1% | Continue Teams Graph team/channel breadth: channel-info |
