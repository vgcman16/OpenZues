...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~78.1% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin runtime-store shim slice is checkpointed in `57cc0f37`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Runtime-store shim checkpointed in `57cc0f37` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime breadth |
