...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~71.2% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin routing helper shim slice is checkpointed in `2cf7fb27`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Routing helper shim checkpointed in `2cf7fb27` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
