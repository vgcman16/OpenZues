...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~61.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The QR setup-code bootstrap handoff slice is checkpointed in `5262359f`.
...
| OZ-COMP-001 | Companion apps/nodes parity | QR setup-code handoff checkpointed in `5262359f` | Repo-wide +0.1%, companion/setup breadth +0.1% | Continue companion QR/setup-code JSON/human/remote breadth |
