...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~73.7% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin keyed-async-queue shim slice is checkpointed in `4307d460`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Keyed-async-queue shim checkpointed in `4307d460` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
