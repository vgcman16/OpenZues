...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~95.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK browser-profiles helper slice is checkpointed in
`73d20703`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Browser profiles SDK helper shim checkpointed in `73d20703` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader SDK helper/runtime breadth |
