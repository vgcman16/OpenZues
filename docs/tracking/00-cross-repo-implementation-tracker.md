...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~75.9% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin direct-DM shim slice is checkpointed in `6534f0db`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Direct-DM shim checkpointed in `6534f0db` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
