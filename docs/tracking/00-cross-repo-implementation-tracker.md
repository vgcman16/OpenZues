...
| Active gateway/session/tool-contract path | ~99.945% | Near-complete bounded local path | `docs/openclaw-parity-progress.md` |
...
bounded-command parity to ~99.4%. Continue `browser.request` local
control-service fallback, provider-specific media/reply edges, companion
