...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~89.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin memory-core-host-query slice is checkpointed in `0eaf8bf8`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Memory core host query checkpointed in `0eaf8bf8` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader unresolved helper/runtime queue; next likely memory-core-host-multimodal or memory-core-host-secret |
