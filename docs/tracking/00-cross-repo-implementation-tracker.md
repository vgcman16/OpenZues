...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~88.6% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin ACP runtime facade slice is checkpointed in `44166f55`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | ACP runtime facade checkpointed in `44166f55` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Rotate to broader unresolved helper/runtime queue |
