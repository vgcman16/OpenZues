...
The plugin inspect human install section slice is checkpointed in `5ca0a5f2`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Plugin inspect human install section checkpointed in `5ca0a5f2` | Repo-wide +0.1%, CLI/runtime +0.1% | Continue real installed module import/activation depth |
