...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~75.3% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin channel-route shim slice is checkpointed in `0f67c4a0`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Channel-route shim checkpointed in `0f67c4a0` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader plugin SDK helper/runtime surface breadth |
