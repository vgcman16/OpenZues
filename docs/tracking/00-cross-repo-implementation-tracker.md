...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~99.5% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK command-status-runtime facade slice is checkpointed in
`b0242a2c`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Command status runtime SDK shim checkpointed in `b0242a2c` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue exact `reply-runtime` alias |
