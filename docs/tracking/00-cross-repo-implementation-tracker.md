...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~92.0% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin SDK image-generation-runtime slice is checkpointed in
`719fcee8`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Image-generation-runtime SDK shim checkpointed in `719fcee8` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue broader unresolved helper/runtime queue; next `video-generation-runtime` |
