...
| --- | ---: | --- | --- |
| Repo-wide OpenClaw parity in OpenZues | ~85.8% | Active, broad parity still open | `docs/openclaw-parity-progress.md`, `docs/openclaw-parity-unresolved-seams.md` |
...
The imported plugin approval-handler capability bridge slice is checkpointed in
`6ea77847`.
...
| OZ-PLUGIN-001 | Real installed plugin module import/activation | Approval-handler capability bridge checkpointed in `6ea77847` | Repo-wide +0.1%, plugin metadata/runtime +0.1% | Continue native expiration scheduling breadth |
