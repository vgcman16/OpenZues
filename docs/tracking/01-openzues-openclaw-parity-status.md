...
Latest verified adjustment: `OZ-PROV-001HE` outbound unsafe `http://` MEDIA
directive rejection moves provider-native inbound/outbound breadth to
~99.99999971%;
