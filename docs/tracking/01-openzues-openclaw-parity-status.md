...
| Packaging/companion app breadth | ~5.5% | Low, broad parity still open | QR setup-code safety, SecretRef slices, device pairing CLI mutations, approve-preview gateway flag preservation, and remote device list/approve dispatch are landed; companion apps remain mostly open |
