...
Latest verified adjustment: `OZ-PLUGIN-00385` channel plugin runtime activation
entries are source/test checkpointed in `30870984`, moving runtime/CLI/doctor
native-bridge parity to ~99.999999993%. Repo-wide OpenClaw parity remains
estimated at ~99.9%.
