...
Latest verified adjustment: `OZ-PLUGIN-00386` channel plugin activation source
config is source/test checkpointed in `2e8f212c`, moving runtime/CLI/doctor
native-bridge parity to ~99.999999994%. Repo-wide OpenClaw parity remains
estimated at ~99.9%.
