...
Latest verified adjustment: `OZ-PROV-001HM` Mattermost native reaction actions
are source/test checkpointed in `1f2783fa`, moving provider-native
inbound/outbound breadth to ~99.99999979%. Repo-wide OpenClaw parity remains
estimated at ~99.9%.
