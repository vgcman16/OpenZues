...
| Packaging/companion app breadth | ~5.4% | Low, broad parity still open | QR setup-code safety, SecretRef slices, device pairing CLI mutations, and approve-preview gateway flag preservation are landed; companion apps remain mostly open |
