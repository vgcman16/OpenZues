...
Latest verified adjustment: `OZ-PLUGIN-00384` package channel command metadata
is source/test checkpointed in `ce9eeaf8`, moving runtime/CLI/doctor
native-bridge parity to ~99.99999999%. Repo-wide OpenClaw parity remains
estimated at ~99.9%.
