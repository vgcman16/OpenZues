...
Latest verified adjustment: `OZ-PKG-001DM` logs broken-pipe handling is
source/test checkpointed in `a4b1114c`, moving runtime/CLI/doctor native-bridge
parity to ~99.999999995%. Repo-wide OpenClaw parity remains estimated at
~99.9%.
