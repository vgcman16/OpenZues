...
- Broader provider-native outbound runtime breadth for remaining provider-specific media edge cases beyond the route send/poll CLI surface, including auto-kind grouping plus Discord/Telegram production live provider-backed channel resolve.
