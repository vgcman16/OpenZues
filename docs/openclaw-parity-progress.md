...
| CLI + operator control plane | Partial | ~69% | Status, continue, queue, recover/harden, gateway doctor, delivery replay, route creation, direct route send/poll, sandbox inventory, and operator monitor surfaces exist; broader runtime CLI/TUI breadth remains. |
