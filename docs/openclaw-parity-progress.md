...
- Updated: 2026-05-02.
- Estimated repo-wide parity: ~53.3% overall, with a reasonable band of ~49-58%.
- Estimated active gateway/session/tool-contract family parity: ~98.8% for the bounded local OpenZues path.
