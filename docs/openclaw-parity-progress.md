...
| CLI + operator control plane | Partial | ~73% | Status, continue, queue, recover/harden, gateway doctor, delivery replay, route creation, direct route send/poll, sandbox inventory, sessions spawn/wait, plugins list, and operator monitor surfaces exist; broader runtime CLI/TUI breadth remains. |
