...
- Broader provider-native outbound runtime breadth for remaining provider-specific edge cases beyond the verified Telegram topic-qualified send/poll paths and WhatsApp text chunking/media payloads.
