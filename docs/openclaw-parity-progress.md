...
- Updated: 2026-05-02.
- Estimated repo-wide parity: ~52.6% overall, with a reasonable band of ~48-57%.
- Estimated active gateway/session/tool-contract family parity: ~98.1% for the bounded local OpenZues path.
