...
- Plugin update flows, remote marketplace clone/update breadth, and production plugin metadata inventory beyond the fakeable ordered executor registry.
