...
- Repo-wide OpenClaw parity is estimated at ~81.8% overall, with a reasonable
  band of ~78-83%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  channel-contract-testing, channel-targets, channel-streaming, and
  channel-envelope helper slices.
