...
- Repo-wide OpenClaw parity is estimated at ~75.8% overall, with a reasonable
  band of ~50-70%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  imported plugin SDK allow-from, access-groups, direct-DM access, and
  direct-DM guard-policy helper slices.
