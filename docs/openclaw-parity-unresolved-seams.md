...
- Repo-wide OpenClaw parity is estimated at ~86.5% overall, with a reasonable
  band of ~78-87%.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  native-command-config-runtime/host-runtime/poll-runtime/lazy-runtime/
