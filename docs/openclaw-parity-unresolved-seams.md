...
- Repo-wide OpenClaw parity is estimated at ~83.6% overall, with a reasonable
  band of ~78-85%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  host-runtime, image-generation-core auth-runtime, model-session-runtime, and
  process-runtime command helper slices.
