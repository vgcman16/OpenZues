...
- Repo-wide OpenClaw parity is estimated at ~88.4% overall, with a reasonable
  band of ~78-89%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  diffs helper, acpx helper, approval-auth-helpers,
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  config-schema/entrypoints/diffs/acpx/
