...
- Repo-wide OpenClaw parity is estimated at ~87.9% overall, with a reasonable
  band of ~78-88%.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  browser-security-runtime/fetch-runtime/cli-backend/
