...
- Repo-wide OpenClaw parity is estimated at ~86.7% overall, with a reasonable
  band of ~78-87%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  config-paths helper, context-visibility-runtime helper, approval-auth-helpers,
