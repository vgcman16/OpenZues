...
- Repo-wide OpenClaw parity is estimated at ~78.3% overall, with a reasonable
  band of ~76-81%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  directory-runtime helper slices.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  runtime-store/runtime/directory-runtime path, starting with the next
