...
backend wiring, image generate/edit runtime commands, audio/video/web/embedding
runtime commands, deeper TTS provider/runtime breadth beyond the now-landed CLI
family, and any
...
now repeats that envelope output for each requested image file.
