...
- Repo-wide OpenClaw parity is estimated at ~78.4% overall, with a reasonable
  band of ~76-81%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  directory-runtime, and directory-config-runtime helper slices.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  runtime-store/runtime/directory-runtime/directory-config-runtime path, starting with the next
