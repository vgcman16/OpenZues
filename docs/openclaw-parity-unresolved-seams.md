...
- Repo-wide OpenClaw parity is estimated at ~49.7% overall, with a reasonable
  band of ~45-54%.
...
- The chat/session contract subfamily is estimated at ~98% after the latest
  ...
  runtime seams.
- The runtime/CLI/doctor native-bridge family is estimated at ~99.0% after the
  ...
  spec-overrides, npm-not-found bundled fallback, hook-pack npm update, and
  hook-pack npm install fallback slices.
- The CLI/operator control-plane family is estimated at ~99.0% after the bundle
