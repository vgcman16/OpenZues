...
backend wiring, image generate/edit/describe-many runtime commands,
audio/video/web/embedding runtime commands, deeper TTS provider/runtime breadth
...
OpenClaw's normalized image-description envelope.
