...
- Repo-wide OpenClaw parity is estimated at ~83.4% overall, with a reasonable
  band of ~78-84%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  host-runtime and image-generation-core auth-runtime helper slices.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  image-generation-core.auth.runtime/model-session-runtime/
