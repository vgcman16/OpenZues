...
plugin CLI parity is compatibility notices, plugin update flows, remote
marketplace clone/update breadth, and deeper production plugin metadata
...
intact and reporting OpenClaw-shaped action metadata.
