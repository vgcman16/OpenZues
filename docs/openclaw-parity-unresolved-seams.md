...
- Repo-wide OpenClaw parity is estimated at ~80.1% overall, with a reasonable
  band of ~78-83%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  channel pairing path, channel inbound roots, and channel location helper
  slices.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  channel-pairing-paths/channel-inbound-roots/channel-location path, starting
