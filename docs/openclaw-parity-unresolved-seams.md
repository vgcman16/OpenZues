...
- Repo-wide OpenClaw parity is estimated at ~86.9% overall, with a reasonable
  band of ~78-87%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  helper, json-store helper, approval-auth-helpers,
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  context-visibility-runtime/heartbeat-runtime/json-store/
