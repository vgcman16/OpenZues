...
- The CLI/operator control-plane family is estimated at ~99.91% after the bundle
...
- Fully locked bounded slices are now tracked in
  ...
  diagnostics/Tailscale serve breadth, and companion app parity.
