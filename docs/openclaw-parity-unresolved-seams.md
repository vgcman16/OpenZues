...
- Repo-wide OpenClaw parity is estimated at ~81.9% overall, with a reasonable
  band of ~78-83%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  channel-envelope, and channel-mention-gating helper slices.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  channel-mention-gating/channel-entry-contract/
