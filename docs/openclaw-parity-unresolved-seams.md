...
- Repo-wide OpenClaw parity is estimated at ~87.3% overall, with a reasonable
  band of ~78-87%.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  system-event-runtime/oauth-utils/runtime-config-snapshot/
