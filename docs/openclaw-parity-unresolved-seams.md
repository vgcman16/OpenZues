...
- Repo-wide OpenClaw parity is estimated at ~87.0% overall, with a reasonable
  band of ~78-87%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  helper, json-store helper, diagnostic-runtime helper, approval-auth-helpers,
