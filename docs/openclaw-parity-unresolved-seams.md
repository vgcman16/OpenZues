...
- Repo-wide OpenClaw parity is estimated at ~82.1% overall, with a reasonable
  band of ~78-83%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  channel-envelope, channel-mention-gating, channel-runtime-context, and
  channel-activity-runtime helper slices.
