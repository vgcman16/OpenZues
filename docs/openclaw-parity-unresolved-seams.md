...
- Repo-wide OpenClaw parity is estimated at ~84.6% overall, with a reasonable
  band of ~78-85%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  helper, session-visibility helper, and simple-completion-runtime
  extractAssistantText helper slices.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  simple-completion-runtime/channel-entry-contract/
