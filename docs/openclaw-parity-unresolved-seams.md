...
- Repo-wide OpenClaw parity is estimated at ~92.4% overall, with a reasonable
  band of ~80-93%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  adapter-factory, realtime-voice helper, and media-understanding-runtime
  helper slices.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  continuing with `media-understanding`.
