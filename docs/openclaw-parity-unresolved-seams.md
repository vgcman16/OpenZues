...
- Repo-wide OpenClaw parity is estimated at ~79.8% overall, with a reasonable
  band of ~77-82%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  Anthropic Vertex auth-presence, Anthropic Vertex facade, and XAI model-id
  helper slices.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  anthropic-cli/anthropic-vertex-auth-presence/anthropic-vertex/xai-model-id path,
