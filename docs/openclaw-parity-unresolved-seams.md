...
- Repo-wide OpenClaw parity is estimated at ~85.3% overall, with a reasonable
  band of ~78-86%.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  approval-handler-adapter-runtime/approval-handler-runtime/channel-entry-contract/
