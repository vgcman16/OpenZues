...
- Repo-wide OpenClaw parity is estimated at ~87.8% overall, with a reasonable
  band of ~78-88%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  browser-security-runtime helper, fetch-runtime helper, approval-auth-helpers,
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  browser-security-runtime/fetch-runtime/
