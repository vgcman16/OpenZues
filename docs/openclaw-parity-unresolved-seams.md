...
- Repo-wide OpenClaw parity is estimated at ~85.2% overall, with a reasonable
  band of ~78-86%.
...
- The runtime/CLI/doctor native-bridge family is estimated at ~99.9% after the
  ...
  approval-native-helpers, approval-native-runtime delivery-helper, and
  approval-handler-adapter-runtime helper slices.
...
- Next repo-wide queue head: continue broader plugin SDK helper/runtime surface
  ...
  approval-handler-adapter-runtime/channel-entry-contract/
